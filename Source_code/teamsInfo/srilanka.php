...
<?php
    ...
    $sql = "SELECT Team_Name, t.Team_Id, Sponsor FROM Team t JOIN Coach c ON t.Team_Id=c.Team_Id WHERE t.Team_Id='SRI';";
  ...
  <?php
  $sql = "SELECT * FROM Player WHERE Team_Id='SRI';";
  $result = mysqli_query($conn, $sql) or die("Bad query: $sql");
...
<?php
   ...
   $sql = "SELECT p.F_Name, p.L_Name FROM Player p,Captain c  WHERE p.Team_Id='SRI' AND c.player_ID=p.Player_Id;";
   $result = mysqli_query($conn, $sql) or die("Bad query: $sql");
...
?>
  ...
  <?php
  $sql = "SELECT p.F_Name, p.L_Name FROM Player p JOIN ViceCaptain vc ON vc.Player_ID=p.Player_ID WHERE p.Team_Id='SRI';";
  $result = mysqli_query($conn, $sql) or die("Bad query: $sql");
...
$sql = "SELECT * FROM Coach WHERE Team_Id='SRI';";
  $result = mysqli_query($conn, $sql) or die("Bad query: $sql");
...
$sql = "SELECT ST.selection_Team_Id,ST.Coach_F_Name, ST.Team_id,P.F_Name, P.L_Name FROM Selection_Team ST, Selection_Player SP, Player P WHERE ST.selection_Team_Id= SP.selection_Team_Id AND SP.Player_Id=P.Player_Id AND ST.Team_id='SRI';";
  $result = mysqli_query($conn, $sql) or die("Bad query: $sql");
